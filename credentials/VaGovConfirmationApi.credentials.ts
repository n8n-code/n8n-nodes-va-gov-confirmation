...
export class VaGovConfirmationApi implements ICredentialType {
	name = 'N8nDevVaGovConfirmationApi';

	displayName = 'va-gov-confirmation API';

	icon: Icon = { light: 'file:../nodes/VaGovConfirmation/va-gov-confirmation.png', dark: 'file:../nodes/VaGovConfirmation/va-gov-confirmation.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			default: '',
			required: true,
			placeholder: 'https://sandbox-api.va.gov/services/veteran_confirmation/v0',
			description: 'The base URL of your va-gov-confirmation API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
